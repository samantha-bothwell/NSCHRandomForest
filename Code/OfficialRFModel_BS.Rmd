...
DO1b_RF5 <- randomForest(formula = BMICLASS2 ~ ., data = TrainSet_2, importance=TRUE, na.action = na.roughfix, ntree = 500, mtry = 5, keep.forest=TRUE)
...
#FIPSST Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), FIPSST, which.class = ">85th perc",ylab="", main="Partial Dependence on Child Location (State) for Obesity Risk", las=2)

#SC_AGE_YEARS Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), SC_AGE_YEARS, which.class = ">85th perc",ylab="", main="Partial Dependence on Child Age (in Years) for Obesity Risk", las=1)

#SC_HISPANIC_R Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), SC_HISPANIC_R, which.class = ">85th perc",ylab="", main="Partial Dependence on Hispanic Race for Obesity Risk", las=1)

#SC_RACE_R Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), SC_RACE_R, which.class = ">85th perc",ylab="", main="Partial Dependence on Race/Ethnicity for Obesity Risk", las=1.5)

#SC_SEX Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), SC_SEX, which.class = ">85th perc",ylab="", main="Partial Dependence on Sex of Child for Obesity Risk", las=1)

#PHYSACTIV Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), PHYSACTIV, which.class = ">85th perc",ylab="", main="Partial Dependence on Physical Activity Level for Obesity Risk", las=1)

#SCREENTIME Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), SCREENTIME, which.class = ">85th perc",ylab="", main="Partial Dependence on Screentime for Obesity Risk", las=1)

#HOURSLEEP Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), HOURSLEEP, which.class = ">85th perc",ylab="", main="Partial Dependence on Hours Slept for Obesity Risk", las=1)

#K2Q32A Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), K2Q32A, which.class = ">85th perc",ylab="", xlab="Depression Symptoms",main="Partial Dependence on Depression Status for Obesity Risk", las=1)

#K2Q33A Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), K2Q33A, which.class = ">85th perc",ylab="", xlab="Anxiety Symptoms",main="Partial Dependence on Anxiety Disorder Status for Obesity Risk", las=1)

#ACE1 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), ACE1, which.class = ">85th perc",ylab="", xlab="Food Insecurity Frequency",main="Partial Dependence on Food Insecurity for Obesity Risk", las=1)

#ACE3 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), ACE3, which.class = ">85th perc",ylab="", xlab="Parental Divorce", main="Partial Dependence on Parent Divorce for Obesity Risk", las=1)

#ACE4 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), ACE4, which.class = ">85th perc",ylab="", xlab="Parental Death",main="Partial Dependence on Parental Death for Obesity Risk", las=1)

#ACE6 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), ACE6, which.class = ">85th perc",ylab="", xlab="Domestic Violence Experienced",main="Partial Dependence on Domestic Violence Experienced for Obesity Risk", las=1)

#ACE9 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), ACE9, which.class = ">85th perc",ylab="", main="Partial Dependence on Experience Substance Abuse for Obesity Risk", las=1)

#ACE10 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), ACE10, which.class = ">85th perc",ylab="", main="Partial Dependence on Racial Discrimination for Obesity Risk", las=1)

#A1_BORN Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), A1_BORN, which.class = ">85th perc",ylab="", xlab="Foreign-Born Parent", main="Partial Dependence on Parent Immigration Status for Obesity Risk", las=1)

#A1_PHYSHEALTH Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), A1_PHYSHEALTH, which.class = ">85th perc",ylab="", xlab="Parent Physical Health Status", main="Partial Dependence on Parent Physical Health Status for Obesity Risk", las=1)

#BIRTHWT Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), BIRTHWT, which.class = ">85th perc",ylab="", main="Partial Dependence on Child Birth weight for Obesity Risk", las=1)

#BULLIED_R Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), BULLIED_R, which.class = ">85th perc",ylab="", xlab="Child Being Bullied", main="Partial Dependence on Bullied Status for Obesity Risk", las=1)

#CURRCOV Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), CURRCOV, which.class = ">85th perc",ylab="", xlab="Healthcare Coverage", main="Partial Dependence on Current Healthcare Coverage for Obesity Risk", las=1)

#FPL_I1 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), FPL_I1, which.class = ">85th perc",ylab="", main="Partial Dependence on Family-Poverty Ratio for Obesity Risk", las=2)

#HIGRADE_TVIS Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), HIGRADE_TVIS, which.class = ">85th perc",ylab="", xlab="Parent Education Level", main="Partial Dependence on Parental Education Level for Obesity Risk", las=1)

#A1_BORN Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), A1_BORN, which.class = ">85th perc",ylab="", xlab="Parent Immigration Status", main="Partial Dependence on Parent Immigration Status for Obesity Risk", las=1)

#K10Q11 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), K10Q11, which.class = ">85th perc",ylab="", xlab="Neighborhood Walkability", main="Partial Dependence on Neighborhood Walkability for Obesity Risk", las=1)

#K10Q22 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), K10Q11, which.class = ">85th perc",ylab="", xlab="Deteriorating Housing Conditions", main="Partial Dependence on Neighborhood Structural Integrity for Obesity Risk", las=1)

#K10Q40_R Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), K10Q40_R, which.class = ">85th perc",ylab="", xlab="Agreement on Neighborhood Safety", main="Partial Dependence on Neighborhood Safety for Obesity Risk", las=1)

#K7Q30 Partial Dependence Plot on Obese Classification
partialPlot(DO1b_RF5, as.data.frame(TrainSet_2), K7Q30, which.class = ">85th perc",ylab="", xlab="Sports Involvement", main="Partial Dependence on Sports Involvement for Obesity Risk", las=1)
```